...
class LtVolunteer
{
     ...
     * Add eventcreateid
     *
     * @param \Application\Entity\LtEvent $eventcreateid
     *
     * @return LtVolunteer
     */
    public function addEventcreateid(\Application\Entity\LtEvent $eventcreateid)
    {
    ...
    /**
     * Remove eventcreateid
     *
     * @param \Application\Entity\LtEvent $eventcreateid
     */
    public function removeEventcreateid(\Application\Entity\LtEvent $eventcreateid)
    {
        $this->eventcreateid->removeElement($eventcreateid);
    }
     ...
     */
    public function getEventcreateid()
    {
